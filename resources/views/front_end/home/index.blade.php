...
@section('content')
                ...
                <div class="section">
                    ...
                    <div class="actions">
                        <a class="b-daf btn btn-danger btn-lg btn-block" href="{{ route('mulai-investasi.index') }}">Mulai
                            Investasi</a>
                        <a class="b-mul btn btn-light btn-lg btn-block"
                                            ...
                                            <a data-toggle="modal" id="detail_now" class="mod_now detail_now moldla"
                                                ...
                                                <div class="card moldla">
                                                    <img class="rectangle-2 moldla"
                                                        src="{{ $np['pictures'][0]['picture'] }}" />
                                                </div>
                                            </a>
                                            <a class="molpli"
                                                href="{{ url('detail-now-playing') }}/{{ $np['id'] }}">
                                                            ...
                                                            <div class="info-dan-progress">
                                                                <div class="info-pendanaan">
                                                                    <div class="mulai-rp1000000 inter-normal-mercury-14px">
                                                                        <span
                                                                            class="tx-sold span-1 inter-normal-mercury">Mulai
                                                                            &nbsp;<span
                                                                                class="tx-sold span-1 inter-bold-white-14px"
                                                                                style="font-weight: bold">Rp
                                                                                {{ number_format(round($np['price'] * 100, 0), 0, ',', '.') }}</span>
                                                                        </span>
                                                                    </div>
                                                                </div>
                                                                <div class="address">
                                                            ...
                                                            <div class="footer-card-1">
                                                                <div
                                                                    ...
                                                                    <span class="inter-normal-quill-gray-12px">Total
                                                                        ...
                                                                        class="inter-medium-alabaster-12px">Rp{{ number_format($np['supply'] * $np['price'], 0, ',', '.') }}</span>
                                                                </div>
                                                                <div
                            ...
                            <div class="row">
                                <div id="owl-demo3" class="owl-carousel owl-theme"
                                                                    ...
                                                                    <a href="{{ route('login') }}" style="cursor: pointer">
                                                                        <div class="icon-and-supporting-text">
                                                                            ...
                                                                            <div class="address-2 inter-normal-alabaster-10px">
                                                                                <span
                                                                                    class="tx-icon inter-normal-alabaster">{{ $cs->likes }}
                                                                                    Suka</span>
                                                                            </div>
                                                                        </div>
                                                                    </a>
                                  ...
                                  style="cursor: pointer"> --}}
                                                ...
                                                <form id="like{{ $cs->id }}"
                                                    action="{{ url('addLike') }}/{{ $cs->id }}" method="POST"
                                                    enctype="multipart/form-data">
                                                    {{ csrf_field() }}
                                                </form>

                                                <form id="sublike{{ $cs->id }}"
                                                    action="{{ url('subLike') }}/{{ $cs->id }}" method="POST"
                                                    enctype="multipart/form-data">
                                                    {{ csrf_field() }}
                                                </form>
                                            @endguest
                                                ...
                                                <a href="{{ route('login') }}" style="cursor: pointer">
                                                    <div class="icon-and-supporting-text-2">
                                                        <i class="icon-com iconheart fas fa-comments"
                                                            style="color: #fff; font-size: 18px;"></i>
                                                        <div class="address-2 inter-normal-alabaster-10px">
                                                            <span class="tx-icon inter-normal-alabaster">{{ $cs->cmt }}
                                                                Komentar</span>
                                                        </div>
                                                    </div>
                                                </a>
                        ...
                        <div class="fashion_section_2">
                            <div class="row">
                                    ...
                                    @foreach ($sold_out as $item)
                                        ...
                                        <div class="item">
                                            ...
                                            <a data-toggle="modal" id="detail_sold" style="width: 100%;"
                                                class="mod_sold detail_sold moldla"
                                            ...
                                            <a type="button" class="molpli"
                                                href="{{ url('detail-sold-out') }}/{{ $item->id }}">
                                                <div class="card molpli">
                                                    <img class="rectangle-2"
                                                        src="https://storage.googleapis.com/asset-santara/santara.co.id/token/{{ $picture[0] }}" />
                                                    <div class="content">
                                ...
                                border-radius: 10px; box-shadow: 10px 0 0 var(--falu-red), 0px 0 0 var(--falu-red); line-height : 20px; padding-left:10px;">
                                                                ...
                                                                <div class="header">
                                                                    <div
                                                                        class="saka-logistics inter-medium-alabaster-20px">
                                                                        <span class="tx-pt inter-medium-alabaster">
                                                            ...
                                                            <div class="info-pendanaan">
                                                                <div class="mul inter-normal-mercury-12px">
                                                                    <span
                                                                        class="tx-sold span-1 inter-normal-quill-gray">Total
                                                        ...
                                                        <div class="footer-card">
                                                            ...
                                                            <div class="footer-card-1">
                                                                ...
                                                                <div
                                                                    class="pembagian-dividen-1-kali inter-normal-mercury-10px">
    ...
    @foreach ($soon as $item)
        <div class="modal fade" id="mdlvot{{ $item->id }}" tabindex="-1" role="dialog"
                                    ...
                                    <tr>
                                        <form id="ajaxform{{ $item->id }}">
                                            ...
                                            <td width="100%" valign="top" style="margin-right: 5px;">
                                                ...
                                                <span class="error" style="font-size: 10px; color:red"
                                                    id="comment_error">
                                                </span>
                                            </td>
                                            <td rowspan="2"
                          ...
                          {{ csrf_field() }}
                                    ...
                                    @else
                                        <a class="col-3" style="cursor: pointer" data-id="{{ $cs->id }}"
                                            id="mct" data-toggle="modal" data-dismiss="modal" data-target="#modal"
                                            class="cmt">
                                            <div class="icon-and-supporting-text-2">
                                                <i class="icon-com iconheart fas fa-comments"
                                                    style="color: #fff; font-size: 18px;"></i>
                                    ...
                                    <a class="col-3" style="cursor: pointer" id="msb"
                                        data-id="{{ $cs->id }}" data-toggle="modal" data-target="#modalShareButton"
                                        data-dismiss="modal">
                                        <div class="icon-and-supporting-text-1">
                                            <i class="icon-com iconheart fas fa-share"
                                                style="color: #fff; font-size: 18px;"></i>
    ...
    @foreach ($now_playing as $np)
        ...
        ?>
        <div class="modal fade" id="modal_now{{ $np['id'] }}" tabindex="-1" role="dialog"
            aria-labelledby="detail_now" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="card" style="margin-bottom: -1px;">
    ...
    @foreach ($sold_out as $item)
        ...
        <div class="modal fade" id="modal_sold{{ $item->id }}" tabindex="-1" role="dialog"
            aria-labelledby="detail_sold" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="card" style="margin-bottom: -1px;">
                        <img class="rectangle-2"
