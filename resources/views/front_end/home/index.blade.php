            ...
            <div class="section">
                <div class="header-dan-supporting-text">
                    ...
                    <div class="tx-sb inter-normal-alabaster-18px">
                        <span class="text-sb inter-normal-alabaster">Platform Equity Crowdfunding pertama yang berizin
                            dan diawasi
                ...
                <div class="actions">
                    <a class="b-daf btn btn-danger btn-lg btn-block" href="{{ route('mulai-investasi.index') }}">Mulai
                        Investasi</a>
                    <a class="b-mul btn btn-light btn-lg btn-block" href="{{ route('daftar-bisnis.index') }}">Daftarkan
                        Bisnis</a>
                </div>
            </div>
        </div>
    ...
    <div id="jewellery_main_slider" class="carousel slide" data-ride="carousel">
                            ...
                            <div id="owl-demo2" class="owl-carousel owl-theme"
                                ...
                                <div class="item">
                                    ...
                                    <a data-toggle="modal" id="detail_now" class="mod_now detail_now moldla"
                                        style="width: 100%;" data-target="#modal_now{{ $np['id'] }}"
                                        data-id="{{ $np['id'] }}">
                                                    ...
                                                    <div class="info-dan-progress">
                                                        <div class="info-pendanaan">
                                                            <div class="mulai-rp1000000 inter-normal-mercury-14px">
                                                                <span class="tx-sold span-1 inter-normal-mercury">Mulai
                                                                    &nbsp;<span
                                                                        class="tx-sold span-1 inter-bold-white-14px"
                                                                        style="font-weight: bold">Rp
                                                                        {{ number_format(round($np['price'] * 100, 0),
                                                                        0, ',', '.') }}</span>
                                                                </span>
                                                            </div>
                                                        </div>
                                                        <div class="address">
                                                            <div class="hr inter-bold-white-14px">
                                                                <span class="tx-sold inter-medium-white"><b
                                                                        ...
                                                                        <?php
                                                                                ...
                                                                                $datediff = $end - $now;
                                                                                ?>
                                                                        @if (round($datediff / (60 * 60 * 24)) < 0) 0
                                                                            @else {{ round($datediff / (60 * 60 * 24))
                                                                            }} @endif {{-- {{abs(strtotime($np->
                                                                            begin_period) -
                                                                            strtotime($np->end_period))}} --}}
                                                                            {{-- 45 --}}
                                                                            {{--
                                                                            <?= $diff ?> --}}
                                                                    </b></span>
                                                            </div>
                                                            {{-- {{abs(strtotime($np->begin_period) -
                                                            strtotime($np->end_period))}} --}}
                                                            <span class="inter-normal-mercury-12px">&nbsp;</span>
                                                            <div class="hr-lg inter-normal-mercury-14px">
                                                                <span class="tx-sold inter-normal-mercury">Hari
                                                                    Lagi</span>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="percent inter-medium-white-12px">
                                                                {{-- <div class="progress-bar "
                                                                    ...
                                                                    <div class="progress-bar "
                                                                        ...
                                                                        role="progressbar"
                                                                        aria-valuenow="{{ $terjual_percentage_f }}"
                                                                        aria-valuemin="0" aria-valuemax="100">
                                                    ...
                                                    <div class="footer-card">
                                                        ...
                                                        <div class="footer-card-1">
                                                            <div
                                                                ...
                                                                <span class="inter-normal-quill-gray-12px">Total
                                                                    Pendanaan<br /></span><span
                                                                    class="inter-medium-alabaster-12px">Rp{{
                                                                    number_format($np['supply'] * $np['price'], 0, ',',
                                                                    '.') }}</span>
                                                            </div>
                                                            <div
                                                                class="periode-dividen-6-bulan inter-normal-mercury-10px">
                                                                <span class="inter-normal-quill-gray-12px">Periode
                                                                    Dividen<br /></span><span
                                                                    class="inter-medium-alabaster-12px">{{ $np['period']
                                                                    }}
                                                                </span>
                                                            </div>
                                                        </div>
        ...
        <div class="but-pag">
            <a class="carousel-control-prev border-1px-cape-cod inter-medium-alabaster-14px customPreviousBtn2"
                href="#jewellery_main_slider" role="button" data-slide="prev"><i
                    class="fas fa-arrow-left"></i>&nbsp&nbsp Prev
            </a>
            <a class="carousel-control-next border-1px-cape-cod inter-medium-alabaster-14px customNextBtn2"
                href="#jewellery_main_slider" role="button" data-slide="next">Next &nbsp&nbsp<i
                                    ...
                                    align-items: center;    width: auto;">
                                                        ...
                                                        <a onclick="document.getElementById('sublike{{ $cs->id }}').submit();"
                                                            ...
                                                            <a onclick="document.getElementById('like{{ $cs->id }}').submit();"
                                                                ...
                                                                {{-- <a
                                                                    onclick="document.getElementById('like{{$cs->id}}').submit();"
                                                                    style="cursor: pointer"> --}}
                                                                    <div class="icon-and-supporting-text">
                                                                        <i class="icon-com iconheart fas fa-heart"
                                                                            style="color: #fff; font-size: 18px;"></i>
                                                                        <div
                                                                            class="address-2 inter-normal-alabaster-10px">
                                                                            <span
                                                                                class="tx-icon inter-normal-alabaster">{{
                                                                                $cs->likes }}
                                                                                Suka</span>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <form id="like{{ $cs->id }}"
                                                                    action="{{ url('addLike') }}/{{ $cs->id }}"
                                                                    method="POST" enctype="multipart/form-data">
                                                                    {{ csrf_field() }}
                                                                </form>

                                                                <form id="sublike{{ $cs->id }}"
                                                                    action="{{ url('subLike') }}/{{ $cs->id }}"
                                                                    method="POST" enctype="multipart/form-data">
                                                                    {{ csrf_field() }}
                                                                </form>
                                                                @endguest
                                                                ...
                                                                @else
                                                                {{-- @if (in_array(Auth::user()->trader->id,
                                                                [$cs->trdvote])) --}}

                                                                {{-- <a
                                                                    onclick="document.getElementById('subvote{{$cs->id}}').submit();"
                                                                    style="cursor: pointer">
                                                                    @else
                                                                    <a onclick="document.getElementById('vote{{$cs->id}}').submit();"
                                                                        ...
                                                                        <a style="cursor: pointer"
                                                                            data-id="{{ $cs->id }}" data-toggle="modal"
                                                                        ...
                                                                        {{-- <form id="vote{{$cs->id}}"
                                                                            action="{{url('addVote')}}/{{$cs->id}}"
                                                                            method="POST" enctype="multipart/form-data">
                                                                            {{ csrf_field() }}
                                                                        </form>
                                                                        <form id="subvote{{$cs->id}}"
                                                                            action="{{url('subVote')}}/{{$cs->id}}"
                                                                            method="POST" enctype="multipart/form-data">
                                                                            {{ csrf_field() }}
                                                                        </form> --}}
                                                                        ...
                                                                        <a style="cursor: pointer"
                                                                            ...
                                                                            <div class="icon-and-supporting-text-2">
                                                                                ...
                                                                                <div
                                                                                    class="address-2  inter-normal-alabaster-10px">
                                                                                    <span
                                                                                        class="tx-icon inter-normal-alabaster">Share</span>
                                                                                </div>
                                                                            </div>
                                                                        </a>
                                                    </div>
                            ...
                            <div id="owl-demo" class="owl-carousel owl-theme div_main"
                                ...
                                <div class="item">
                                    ...
                                    <a data-toggle="modal" id="detail_sold" style="width: 100%;"
                                        class="mod_sold detail_sold moldla" data-target="#modal_sold{{ $item->id }}">
                                        <div class="card moldla">
                                ...
                                border-radius: 10px; box-shadow: 10px 0 0 var(--falu-red), 0px 0 0 var(--falu-red); line-height : 20px; padding-left:10px;">
                                                    ...
                                                    <div class="info-pendanaan">
                                                        <div class="mul inter-normal-mercury-12px">
                                                            <span class="tx-sold span-1 inter-normal-quill-gray">Total
                                                                Pendanaan <span class="tx-sold inter-bold-white"
                                                                    style="font-weight: bold">Rp
                                                                    {{ number_format(round($item->supply *
                                                ...
                                                <div class="footer-card">
                                                    ...
                                                    <div class="footer-card-1">
                                                        <div class="deviden-dibagikan-rp inter-normal-mercury-12px">
                                                            <span class="inter-normal-quill-gray-12px">Deviden
                                                                Dibagikan<br /></span><span
                                                                class="inter-medium-alabaster-12px">Rp{{
                                                                number_format(round($item->dvd), 0, ',', '.') }}</span>
                                                        </div>
                                                        <div class="pembagian-dividen-1-kali inter-normal-mercury-10px">
                                                            <span class="inter-normal-quill-gray-12px">Pembagian
                                                                Dividen<br /></span><span
                                                                class="inter-medium-alabaster-12px">{{ $item->dvc }}
                                                                Kali</span>
                                                        </div>
                                                    </div>
                                                </div>
...
<div class="modal fade" id="mdlvot{{ $item->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            @else
            <?php
                        $value = db::table('emiten_votes')
                            ->where('emiten_id', $item->id)
            ...
            <form action="{{ url('addVot') }}/{{ $item->id }}" method="POST" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="modal-body">
                    ...
                    {{-- <div class="input-group mb-3 text-center" style="width:80%">
                        ...
                        <input type="text" class="form-control text-center number-only-phone"
                            style="background-color: #fff;" id="jumlah_saham" value="{{$s['m']}}" disabled
...
<div class="modal fade" id="modal{{ $item->id }}" tabindex="-1" role="dialog" aria-labelledby="modalLabel"
                                    ...
                                    <form id="ajaxform{{ $item->id }}">
                                        ...
                                        <td width="100%" valign="top" style="margin-right: 5px;">
                                            ...
                                            <textarea class="form-control without-border" id="comment"
                                                name="comment{{ $item->id }}" placeholder="Write a comment" cols="70"
                    ...
                    <div class="text-center modal-body ">
                        ...
                        <div class="row mt-3 mb-3 d-flex justify-content-center ">
                            ...
                            <div class="col-4 col-md-2">
                                <a href="https://www.facebook.com/sharer/sharer.php?u={{ url('detail-coming-soon') }}/{{ $item->id }}"
                                    ...
                                    <img width="50px"
                                        src="https://old.santara.co.id/assets/new-santara/img/sosmed/facebook.png"
                                        class="lazyload">
                            ...
                            <div class="col-4 col-md-2">
                                <a href="https://twitter.com/intent/tweet?url={{ url('detail-coming-soon') }}/{{ $item->id }}&amp;text=Temukan%20peluang%20investasi%20berikut%20di%20Santara!%0A PT. Lembu Sora Lampung"
                                    ...
                                    <img width="50px"
                                        src="https://old.santara.co.id/assets/new-santara/img/sosmed/twitter.png"
                                        class="lazyload">
                            ...
                            <div class="col-4 col-md-2">
                                <a href="https://telegram.me/share/url?url={{ url('detail-coming-soon') }}/{{ $item->id }}&amp;text=Temukan%20peluang%20investasi%20berikut%20di%20Santara!%0A PT. Lembu Sora Lampung"
                                    ...
                                    <img width="50px"
                                        src="https://old.santara.co.id/assets/new-santara/img/sosmed/telegram.png"
                                        class="lazyload">
                            ...
                            <div class="col-4 col-md-2">
                                <a href="https://web.whatsapp.com/send?text=Temukan%20peluang%20investasi%20berikut%20di%20Santara!%0A {{ url('detail-coming-soon') }}/{{ $item->id }}"
                                    ...
                                    <img width="50px"
                                        src="https://old.santara.co.id/assets/new-santara/img/sosmed/whatsapp.png"
                                        class="lazyload">
                        ...
                        <div class="input-group input-group-lg mb-3">
                            ...
                            <span id="copy-link" class="input-group-text"
                                ...
                                onclick="shareButton('{{ url('detail-coming-soon') }}/{{ $item->id }}')">Copy
                                Link</span>
                        </div>
                    </div>
                                    ...
                                    <a class="col-3" href="{{ route('login') }}" style="cursor: pointer">
                                        <div class="icon-and-supporting-text">
                                            <i class="icon-com iconheart fas fa-heart"
                                                style="color: #fff; font-size: 18px;"></i>
                                            <div class="address-2 inter-normal-alabaster-10px">
                                                <span class="tx-icon inter-normal-alabaster" id="like"
                                                    style="margin-left:2px;"> Suka</span>
                                            </div>
                                        </div>
                                    </a>
                                    @else
                                    ...
                                    <a class="col-3" id="sl" onclick="" style="cursor: pointer">
                                        ...
                                        <a class="col-3" id="ll" onclick="" style="cursor: pointer">
                                            ...
                                            <a class="col-3" href="{{ route('login') }}" style="cursor: pointer">
                                                <div class="icon-and-supporting-text-1">
                                                    <i class="icon-com iconheart fas fa-user"
                                                        style="color: #fff; font-size: 18px;"></i>
                                                    <div class="address-2 inter-normal-alabaster-10px">
                                                        <span class="tx-icon inter-normal-alabaster" id="minat">
                                                            Minat</span>
                                                    </div>
                                                </div>
                                            </a>
                                            ...
                                            <a class="col-3"
                                                ...
                                                @else
                                                <a class="col-3"
                                                    onclick="document.getElementById('vote{{$cs->id}}').submit();"
                                                    style="cursor: pointer">
                                                    @endif
                                                    <div class="icon-and-supporting-text-1">
                                                        <i class="icon-com iconheart fas fa-user"
                                                ...
                                                {{-- <form id="vote{{$cs->id}}" action="{{url('addVote')}}/{{$cs->id}}"
                                                    method="POST" enctype="multipart/form-data">
                                                    {{ csrf_field() }}
                                                </form>
                                                ...
                                                <a style="cursor: pointer" data-toggle="modal" data-target="#mdlvot"
                                                    data-dismiss="modal" id="mdlvotbtn">
                                                    <div class="icon-and-supporting-text-1">
                                                        <i class="icon-com iconheart fas fa-user"
                                                            style="color: #fff; font-size: 18px;"></i>
                                                        <div class="address-2 inter-normal-alabaster-10px">
                                                            <span class="tx-icon inter-normal-alabaster">{{ $cs->vot }}
                                                                Minat</span>
                                                        </div>
                                                    </div>
                                                </a>
                                                ...
                                                <a class="col-3" href="{{ route('login') }}" style="cursor: pointer">
                                                    <div class="icon-and-supporting-text-2">
                                                        <i class="icon-com iconheart fas fa-comments"
                                                            style="color: #fff; font-size: 18px;"></i>
                                                        <div class="address-2 inter-normal-alabaster-10px">
                                                            <span class="tx-icon inter-normal-alabaster" id="comments"
                                                ...
                                                @else
                                                <a class="col-3" style="cursor: pointer" data-id="{{ $cs->id }}"
                                                    id="mct" data-toggle="modal" data-dismiss="modal"
                                                ...
                                                @endguest
                                                <a class="col-3" style="cursor: pointer" id="msb"
                                                    data-id="{{ $cs->id }}" data-toggle="modal"
                                    ...
                                    <div class="hr inter-bold-white-14px">
                                        <span class="tx-sold inter-medium-white"><b style="font-weight: bold">
                                                <?php
                                                    ...
                                                    $datediff = $end - $now;
                                                    ?>
                                                @if (round($datediff / (60 * 60 * 24)) < 0) 0 @else {{ round($datediff /
                                                    (60 * 60 * 24)) }} @endif {{-- {{abs(strtotime($np->begin_period) -
                                                    strtotime($np->end_period))}} --}}
                                                    {{-- 45 --}}
                                                    {{-- {{$diff}} --}}
                                            </b></span>
                            ...
                            <div class="footer-card-1">
                                <div class="total-pendanaan-rp3000000000 inter-normal-mercury-12px">
                                    <span class="inter-normal-quill-gray-12px">Total Pendanaan<br /></span><span
                                        class="inter-medium-alabaster-12px">Rp{{ number_format($np['supply'] *
                                        $np['price'], 0, ',', '.') }}</span>
                                </div>
    ...
    <div class="modal fade" id="modal_sold{{ $item->id }}" tabindex="-1" role="dialog" aria-labelledby="detail_sold"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                    ...
                    <div class="content2">
                        <div class="header-card-dan-progress-2">
                            <div class="header-and-tags">
                                <span class="tx-t inter-medium-sweet-pink-12px"
                                    style="background: var(--falu-red);
                        border-radius: 10px; box-shadow: 10px 0 0 var(--falu-red), 0px 0 0 var(--falu-red); line-height : 20px; padding-left:10px;">{{ $item->ktg
                                    }}</span>
                                <div class="header">
                                    <div class="saka-logistics inter-medium-alabaster-20px">
                            ...
                            <div class="info-pendanaan">
                                <div class="mul inter-normal-mercury-12px">
                                    <span class="tx-sold span-1 inter-normal-quill-gray">Total Pendanaan <span
                                            ...
                                            {{ number_format(round($item->supply * $item->price), 0, ',', '.')
                                            }}</span></span>
                                </div>
                            </div>
                            <div>
                            ...
                            <div class="footer-card-1">
                                <div class="total-pendanaan-rp3000000000 inter-normal-mercury-12px">
                                    <span class="inter-normal-quill-gray-12px">Deviden Dibagikan<br /></span><span
                                        class="inter-medium-alabaster-12px">Rp{{ number_format(round($item->dvd), 0,
                                        ',', '.') }}</span>
                                </div>
                                <div class="periode-dividen-6-bulan inter-normal-mercury-10px">
                ...
                <div class="modal-footer" style="background-color: var(--shark);">
                    <a class="b-daf btn btn-danger btn-lg btn-block"
                        href="{{ url('detail-sold-out') }}/{{ $item->id }}">Selengkapnya</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        $(document).ready(function() {
            $(document).on('click', '.mod', function() {
                ...
                $("form#sublike").prop('id', 'sublike' + id).prop('action', "{{ url('subLike') }}/" +
                    id);
    ...
    <script>
        $(document).ready(function() {
            $(document).on('click', '.detail_sold', function() {
                ...
                $('#image_sold').prop('src',
                    'https://storage.googleapis.com/asset-santara/santara.co.id/token/' + image_sold);
    ...
    @endsection
    @section('js')
    <script type="text/javascript" src="{{ asset('public') }}/app-assets/js/core/alert/sweetalert.min.js">
    </script>
