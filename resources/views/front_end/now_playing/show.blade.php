            ...
            <div class="table-row">
              <span class="inter-medium-delta-16px">Total Rupiah : 100</span>
                        ...
                        font-weight: 500;">
                                        <tr>
                                            <td>Saham Tersisa <br>
                                                {{ number_format($emt->avg_capital_needs > 0 ? round((($emt->avg_capital_needs - $bok->tot) / $emt->avg_capital_needs) * 100, 2) : 0, 2, ',', '.') }}%
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Dalam Lembar <br>
                                                {{ number_format($emt->avg_capital_needs > 0 ? round(($emt->avg_capital_needs - $bok->tot) / $emt->price, 0) : 0, 0, ',', '.') }}
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Total Rupiah <br>
                                                Rp{{ number_format($emt->avg_capital_needs > 0 ? round($emt->avg_capital_needs - $bok->tot, 0) : 0, 0, ',', '.') }}
                                            </td>
                                        </tr>
                                    </table>
                                </div>
                        ...
                        font-weight: 500;">
                                        ...
                                        <tr>
                                            <td>Dalam Lembar <br>
                                                {{ number_format($bok->tot > 0 ? round($bok->tot / $emt->price, 0) : 0, 0, ',', '.') }}</td>
                                        </tr>
                                        <tr>
...
?>
                        ...
                        <div class="tab-pane fade" id="pills-des" role="tabpanel" aria-labelledby="pills-des-tab">
                            <div class="table-row-1">
                                <span class="inter-medium-delta-16px"
                                    style="text-align: justify;">{{ $emt->business_description }}</span>
                            </div>
                        </div> <!-- 3nd card -->
                        <!-- 2nd card -->
                    ...
                    <div class="info-deviden border-1px-cape-cod" style="width: 300px; height: 380px;">
                        ...
                        <div class="table-7">
                            <p class="pembagian-deviden-ta inter-bold-alabaster-24px">
                                <span class="inter-bold-alabaster-24px"
                                    style="color: #fff">Rp{{ number_format(round($emt->price * 100, 0), 0, ',', '.') }}</span><span
                                ...
                                <div class="fashion_section_2">
                                    <div id="owl-demo6" class="owl-carousel owl-theme">
                                        ...
                                        @else
                                            <div class="item">
                                                <img class="rectangle-2"
                                                    src="{{ env('PATH_WEB_PROD') }}{{ $picture[3] }}" />
                                            </div>
                                        @endif
                                        ...
                                        @else
                                            <div class="item">
                                                <img class="rectangle-2"
                                                    src="{{ env('PATH_WEB_PROD') }}{{ $picture[4] }}" />
                                            </div>
                                        @endif
                                        ...
                                        @else
                                            <div class="item">
                                                <img class="rectangle-2"
                                                    src="{{ env('PATH_WEB_PROD') }}{{ $picture[5] }}" />
                                            </div>
                                        @endif
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group row d-flex justify-content-center text-center">
                                    <label for="jumlah_saham" class="mb-2 text-bold col-12">Jumlah Saham yang akan dibeli
                                        dalam kelipatan
                                        100 lembar </label>
