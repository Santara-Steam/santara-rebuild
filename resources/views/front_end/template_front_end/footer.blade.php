        ...
        <div class="row">
          ...
          <div class="col-md-8 mb-4">
            ...
            <p class="tx-f inter-normal-mercury-14px">
              <span class="text-f inter-normal-mercury-14px">Santara Website Ver 5.8.0 - Business Ver 3.6.1 | Copyright
                © 2022 Santara, All rights reserved.</span>
            </p>
            ...
            <div class="santara-app">
              ...
              <div class="action-app">
                <a href="https://play.google.com/store/apps/details?id=id.co.santara.app">
                  <div class="mobile-app-store-badge border-1px-quick-silver">
                    <img class="google-play-logo"
                      src="{{ asset('public/assets/images/google-play-logo-24@2x.png') }}" />
                    <div class="flex-col">
                ...
                <a href="https://apps.apple.com/id/app/santara-app/id1473570177">
                  <img class="mobile-app-store-badge-1"
                    src="{{ asset('public/assets/images/mobile-app-store-badge-24@2x.png') }}" />
                </a>
              </div>
            </div>
