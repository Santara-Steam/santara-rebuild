...
<div class="banner_bg_main"
  style="background-image: url(https://storage.googleapis.com/asset-santara/santara.co.id/token/{{$picture[1]}}); margin-top: 96px;">
    ...
    <div class="col-lg-12">
      <div class="np-timeline" style="box-shadow: 0 3px 2px -2px #404040; min-height: 150px;">
        <ul class="timeline d-flex justify-content-evenly">
          ...
          @else
          <li class="active-tl" data-bs-toggle="tooltip" data-bs-placement="top"
            title="{{date('d M Y', strtotime($tmpra->date))}}">
            <div class="timeline-caption">
              <p class="timeline-text">Pra Penawaran Saham
            </div>
            <div class="timeline-caption">
              <p class="timeline-text">{{date('d-m-Y', strtotime($tmpra->date))}}
            </div>
          </li>
          @endif
          @if(is_null($tmpen))
          ...
          @else
          <li class="active-tl" data-bs-toggle="tooltip" data-bs-placement="top"
            title="{{date('d M Y', strtotime($tmpen->date))}}">
            <div class="timeline-caption">
              <p class="timeline-text">Penawaran Saham
            </div>
            <div class="timeline-caption">
              <p class="timeline-text">{{date('d-m-Y', strtotime($tmpen->date))}}
            </div>
          </li>
          @endif
          @if(is_null($tmpd))
          ...
          @else
          <li class="active-tl" data-bs-toggle="tooltip" data-bs-placement="top"
            title="{{date('d M Y', strtotime($tmpd->date))}}">
            <div class="timeline-caption">
              <p class="timeline-text">Pendanaan Terpenuhi
            </div>
            <div class="timeline-caption">
              <p class="timeline-text">{{date('d-m-Y', strtotime($tmpd->date))}}
            </div>
          </li>
          @endif
          @if(is_null($tmpyd))
          ...
          @else
          <li class="active-tl" data-bs-toggle="tooltip" data-bs-placement="top"
            title="{{date('d M Y', strtotime($tmpyd->date))}}">
            <div class="timeline-caption">
              <p class="timeline-text">Penyerahan Dana
            </div>
            <div class="timeline-caption">
              <p class="timeline-text">{{date('d-m-Y', strtotime($tmpyd->date))}}
            </div>
          </li>
          @endif
          @if(is_null($tm))
          ...
          @else
          <li class="active-tl" data-bs-toggle="tooltip" data-bs-placement="top"
            title="{{date('d M Y', strtotime($tm->date))}}">
            <div class="timeline-caption">
              <p class="timeline-text">Pembagian Dividen
            </div>
            <div class="timeline-caption">
              <p class="timeline-text">{{date('d-m-Y', strtotime($tm->date))}}
            </div>
          </li>
          @endif
        </ul>
              ...
              <div class="col-6">
                ...
                font-weight: 500;">
                  <tr style="font-size:14px; ">
                    <td>Saham Tersisa
                      ...
                      <span style="font-weight:bold; line-height:3;">
                        @if ($emt->avg_capital_needs < 0) {{number_format(round((($emt->
                          avg_capital_needs-$bok->tot)/$emt->avg_capital_needs)*100,0),0,',','.')}}%
                          @else
                          0,00%
                          @endif
                      </span>
                  ...
                  <tr style="font-size:14px;">
                    <td>Dalam Lembar <br>
                      <span style="font-weight:bold; line-height:3;">
                        @if ($emt->price < 0) {{number_format(round(($emt->
                          avg_capital_needs-$bok->tot)/$emt->price,0),0,',','.')}} Lembar
                          @else
                          0 Lembar
                          @endif
                      </span>
              ...
              <div class="col-6">
                ...
                font-weight: 500;">
                  <tr style="font-size:14px;">
                    <td>Saham Terjual <br>
                      <span style="font-weight:bold; line-height:3;">
                        @if ($emt->avg_capital_needs < 0) {{number_format(round(($bok->
                          tot/$emt->avg_capital_needs)*100,0),0,',','.')}}%
                          @else
                          100%
                          @endif
                      </span>
              ...
              <div class="col-6">
                ...
                font-weight: 500;">
                  ...
                  <tr style="font-size:14px;">
                    ...
                    ?>
                        @if ($dt < 0) 0 Hari @else {{round($datediff / (60 * 60 * 24))}} Hari @endif </span>
                    </td>
                  </tr>
                  <tr style="font-size:14px;">
            ...
            <div class="table-cell-row-1">
              <div class="table-cell" style="margin-left: 10px;">
                <p class="pembagian-deviden-ta inter-normal-delta-12px">
                  <span class="inter-normal-delta-12px">Pembagian Deviden Tahap {{$no}} - </span><span
                ...
                <div id="owl-demo6" class="owl-carousel owl-theme">
                  ...
                  <div class="item">
                    <img class="rectangle-2"
                      src="https://storage.googleapis.com/asset-santara/santara.co.id/token/{{$picture[3]}}" />
                  </div>
                  @endif
                  ...
                  <div class="item">
                    <img class="rectangle-2"
                      src="https://storage.googleapis.com/asset-santara/santara.co.id/token/{{$picture[4]}}" />
                  </div>
                  @endif
                  ...
                  <div class="item">
                    <img class="rectangle-2"
                      src="https://storage.googleapis.com/asset-santara/santara.co.id/token/{{$picture[5]}}" />
                  </div>
                  @endif
