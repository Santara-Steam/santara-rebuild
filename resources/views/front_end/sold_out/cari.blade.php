...
<div class="header-section" style="margin-top: 96px;">
  ...
  <div class="text-mulai inter-normal-alabaster-20px">
    <span class="text-mulai inter-normal-alabaster">Mereka sudah merasakan urun dana bersama kami, saatnya Bisnis
      Anda</span>
  </div>
</div>
          ...
          <form role="form" method="get" action="{{ route('sold-out.filter') }}" id="form_id">
            ...
            <div class="form-row">
              <div class="form-group col-md-4">
                ...
                <input type="search" value="{{ $car }}" id="i" onclick="categor.value=''" name="cari"
              ...
              <div class="form-group col-md-3">
                ...
                <select name="categor" id="inputState" class="form-control dropdown-1" onclick="cari.value=''"
              ...
              <div class="form-group col-md-2">
                ...
                <select name="sort" id="inputState" class="form-control dropdown-1"
                  onChange=" document.getElementById('form_id').submit();">
                  <option <?php if ($fil_sort=='desc' ) { echo 'selected' ; } ?>
                    value="desc">Terbaru</option>
                  <option <?php if ($fil_sort=='asc' ) { echo 'selected' ; } ?>
