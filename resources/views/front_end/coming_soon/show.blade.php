            ...
            <div class="table-2">
              <div class="table-cell-row-1">
                <div class="table-cell">
                  <p class="pembagian-deviden-ta inter-normal-delta-12px">
                    <span class="inter-normal-delta-12px">Saham yang dilepas</span
                    ><br><span class="inter-normal-delta-12px" style="font-weight: bold; color: #fff">30%</span>
                  </p>
                </div>
                <div class="table-cell">
                  <p class="pembagian-deviden-ta inter-normal-delta-12px">
                    <span class="inter-normal-delta-12px">Perkiraan omzet penerbit</span
                    ><br><span class="inter-normal-delta-12px" style="font-weight: bold; color: #fff">10.000.000.000</span>
                  </p>
                </div>
              </div>
              <div class="overlap-group-3">
                <div class="table-cell-row">
                  <div class="table-cell">
                  <p class="pembagian-deviden-ta inter-normal-delta-12px">
                    <span class="inter-normal-delta-12px">Perkiraan Dividen</span
                    ><br><span class="inter-normal-delta-12px" style="font-weight: bold; color: #fff">30%</span>
                  </p>
                </div>
                  <div class="table-cell">
                  <p class="pembagian-deviden-ta inter-normal-delta-12px">
                    <span class="inter-normal-delta-12px">Dana yang dibutuhkan</span
                    ><br><span class="inter-normal-delta-12px" style="font-weight: bold; color: #fff">5.000.000.000</span>
                  </p>
                </div>
                </div>
              </div>
              <div class="overlap-group-3">
                ...
                <div class="table-cell-row">
                  <div class="table-cell">
                    <p class="pembagian-deviden-ta inter-normal-delta-12px">
                      <span class="inter-normal-delta-12px" style="white-space: nowrap;">Omzet 2 tahun sebelumnya</span
                      ><br><span class="inter-normal-delta-12px">2020:</span
                      ><br><span class="inter-medium-delta-12px" style="font-weight: bold; color: #fff">9.800.000.000</span>
                    </p>
                  </div>
                  <div class="table-cell" style="margin-top: 10px;">
                  <p class="pembagian-deviden-ta inter-normal-delta-12px">
                    <span class="inter-normal-delta-12px" >2021:</span
                    ><br><span class="inter-normal-delta-12px" style="font-weight: bold; color: #fff">5.000.000.000</span>
                  </p>
                </div>
                  </div>
        ...
        <div class="actions-com">
          <div class="button-5">
            ...
            <div class="address-1 inter-medium-eerie-black-14px">
              <span class="tx-icon inter-medium-eerie-black "><p class="tx-icon">82 </p><p class="com-u">&ensp;Likes</p></span>
            </div>
          </div>
          <div class="button-5">
            <img class="ico-comn" src="{{ asset('public/assets/images/icon-user-47@2x.png') }}" />&ensp;
            <div class="address-1 inter-medium-eerie-black-14px">
              <span class="tx-icon inter-medium-eerie-black"><p class="tx-icon">197 </p> <p class="com-u">&ensp;Minat</p></span>
            </div>
          </div>
          <div class="button-5">
            <img class="icon-com" src="{{ asset('public/assets/images/icon-message-circle-47@2x.png') }}" />&ensp;
            <div class="address-1 inter-medium-eerie-black-14px">
              <span class="tx-icon inter-medium-eerie-black"><p class="tx-icon">18 </p><p class="com-u">&ensp;Komen</p></span>
            </div>
          </div>
          <div class="button-5">
            <img class="icon-com" src="{{ asset('public/assets/images/icon-share-2-47@2x.png') }}" />&ensp;
            <div class="address-1 inter-medium-eerie-black-14px">
              <span class="tx-icon inter-medium-eerie-black"><p class="com-u">&ensp;Share</p></span>
            </div>
          </div>
        </div>
