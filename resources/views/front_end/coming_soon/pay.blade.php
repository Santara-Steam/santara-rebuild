        ...
        {{-- <div class="content-1"> --}}
                ...
                <div class="col-md-12">
                    <div class="card text-white bg-danger mb-3 " style="padding: 20px;">
                        ...
                        <div class="card-body " style="padding: 20px 0px 10px 0px;">
                            <h2 class="c-margin-b-20" style="color: white;font-family: Arial, Helvetica, sans-serif;">
                                4567255777</h2>
            ...
            <div class="row  mb-4">
                ...
                <div class="col-md-12 text-center" style="color: white">
                    Transfer Sebesar <strong>Rp{{ number_format($trx->total_amount,0,',','.') }}</strong> Ke Nomor
                    Rekening Di Atas.
                </div>
            </div>
            <hr>
            <div class="row">
                ...
                <div class="col-md-10">
                    <form action="{{url('/upload_bukti_user')}}/{{$trx->id}}" method="POST"
