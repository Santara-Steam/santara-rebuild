...
@section('content')
    <link rel="canonical" href="https://santara.co.id/syarat-ketentuan-pemodal">
...
<div class="container card-content">
	<div class="card-body">
		<div style="overflow: auto;" class="doc-tnc d-none d-sm-none d-xl-block">
			<embed src="https://santara.co.id/uploads/document/tnc_pemodal.pdf" width="100%" height="1000px" class="doc-tnc-iframe" type="application/pdf">
		</div>

		<a style="display: block;margin-bottom: 20px; color:#fff; text-decoration:none" class="ff-a bold fs-20 text-center d-xl-none" href="https://santara.co.id/uploads/document/tnc_pemodal.pdf" download="tnc_pemodal">Download</a>
	</div>
</div>
<hr>        </div>
    </main>
