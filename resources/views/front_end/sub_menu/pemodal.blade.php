...
@section('content')
    <link rel="canonical" href="https://old.santara.co.id/syarat-ketentuan-pemodal">
	...
	<div class="container  text-center d-flex justify-content-center" style="border-top: solid #4A585A;">
		<h1 class="ff-m fs-24 font-header c-gold" style="font-weight: 800;
    text-transform: uppercase;
    margin-top: -15px;
    padding: 0px 50px;
    background-color: #1A1A1A;">Syarat Dan Ketentuan Pemodal</h1>
	</div>
</div>
<div class="container card-content">
	<div class="card-body">
		<div style="overflow: auto;" class="doc-tnc d-none d-sm-none d-xl-block">
			<embed src="https://old.santara.co.id/uploads/document/tnc_pemodal.pdf" width="100%" height="1000px" class="doc-tnc-iframe" type="application/pdf">
		</div>

		<a style="display: block;margin-bottom: 20px; color:#fff; text-decoration:none" class="ff-a bold fs-20 text-center d-xl-none" href="https://old.santara.co.id/uploads/document/tnc_pemodal.pdf" download="tnc_pemodal">Download</a>
	</div>
</div>
<hr>        </div>
    </main>
