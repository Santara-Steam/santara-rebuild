...
@section('content')
    <link rel="canonical" href="https://santara.co.id/kontak-kami">
    ...
    <main>
        <div style="padding-top: 80px;">
            <link rel="stylesheet" type="text/css" href="https://santara.co.id/assets/new-santara/css/kontak-kami.css?v=5.8.8">

<div class="d-flex justify-content-evenly mt-5">
    <div class="container  text-center d-flex justify-content-center" style="border-top: solid #4A585A;">
        <h1 class="ff-m fs-24 font-header c-gold">kontak kami</h1>
    </div>
</div>
<div class="container-kontak">
    <div class="row row-kontak pt-4 pb-4">
        <div class="col-12 col-lg-8 mt-3">
            <div class="row-detail-kontak">
                <h1 class="font-pt red-kontak ff-a bold">PT. Santara Daya Inspiratama</h1>
                <p class="ff-n font-alamat" style="color:#fff;">
                    STC Senayan, Jl. Asia Afrika Pintu IX No. 179A, RT.1/RW.3,
                    Senayan, Kecamatan Tanah Abang, Kota Jakarta Pusat, Daerah Khusus Ibukota Jakarta 10270</p>
                <table class="font-alamat ff-n mb-4">
                    <tbody>
                        <tr>
                            <td style="color:#fff;">Telepon</td>
                            <td style="padding-left: 5px;">: <span class="red-kontak bold"> 021 5224022</span>
                            </td>
                        </tr>
                        <tr>
                            <td style="color:#fff;">Email</td>
                            <td style="padding-left: 5px;">: <span class="red-kontak bold"> official@santara.co.id</span>
                            </td>
                        </tr>
                        <tr>
                            <td style="color:#fff;">WhatsApp</td>
                            <td style="padding-left: 5px;">: <span class="red-kontak bold"> +6281212227765</span>
                            </td>
                        </tr>
                    </tbody>
                </table>
                <hr>
                <h2 class="ff-a fs-18" style="color:#fff;">Follow Kami</h2>
                <div class="row">
                    <div class="col-12">
                        <a href="#"><img src="https://santara.co.id/assets/new-santara/img/logo/ig-kontak.svg" class="logo-sosmed" width="40px" alt="ig-kontak"></a>
                        <a href="#"><img src="https://santara.co.id/assets/new-santara/img/logo/fb-kontak.svg" class="logo-sosmed" width="40px" alt="ig-kontak"></a>
                        <a href="#"><img src="https://santara.co.id/assets/new-santara/img/logo/tw-kontak.svg" class="logo-sosmed" width="40px" alt="ig-kontak"></a>
                        <a href="#"><img src="https://santara.co.id/assets/new-santara/img/logo/tt-kontak.svg" class="logo-sosmed" width="40px" alt="ig-kontak"></a>
                    </div>
                </div>
            </div>
        </div>
        <div class="map-santara col-12 col-lg-4 mt-3">
            <iframe class="row-map" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3966.2708258100492!2d106.79656921471674!3d-6.227980595491689!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69f13c35afc91d%3A0xbf510a1c44ecd78!2sSTC%20Senayan%20City.!5e0!3m2!1sid!2sid!4v1647843418904!5m2!1sid!2sid" width="100%" height="295" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
            <!-- <iframe class="row-map" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3952.9145169337335!2d110.32535701459842!3d-7.798874894379889!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e7af949d7abe11d%3A0x94ba5aae4b549072!2sSantara!5e0!3m2!1sid!2sid!4v1643103537894!5m2!1sid!2sid" width="100%" height="295" style="border:0;" allowfullscreen="" loading="lazy"></iframe> -->
        </div>
    </div>
</div>        </div>
    </main>
