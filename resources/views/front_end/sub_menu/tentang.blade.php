...
@section('content')
<link rel="canonical" href="https://old.santara.co.id/tentang-santara">
    ...
    <link rel="stylesheet" type="text/css" href="https://old.santara.co.id/assets/new-santara/css/tentang-santara.css?v=5.8.8">
<div class="banner" style="padding-top: 80px;">
    <div class="container py-5">
        <div class="row" style="display: flex;">
            <div class="col-lg-6 col-sm-12">
                <div class="text-1" style="white-space: normal;">
                    <p>Selamat Datang
                        di Santara
                    </p>
                </div>
                <div class="text-2" style="white-space: normal;">
                    <p style="font-family:Nunito;font-size: 17pt; margin-top:25px; color: #fff;">
                        Platform Equity Crowdfunding pertama yang
                        berizin dan diawasi Otoritas Jasa Keuangan berdasarkan Surat Keputusan Nomor:
                        <br>
                        KEP-59/D.04/2019.
                    </p>
                </div>

                <div class="text-3" style="white-space: normal;">
                    <p>
                        Yuk, jadi bagian dari #SejutaUKMNaikKelas
                    </p>
                </div>
            ...
            <div class="col-lg-6 col-sm-12">
                <img src="https://old.santara.co.id/assets/images/svg/banner.svg" class="img-fluid" />
            </div>
...
<div class="container py-5">
    <div class="info-santara ff-n">
        <p style="font-weight: bold; font-family:Nunito; color: #fff;">Apa itu Equity Crowdfunding?</p>
        <p style="padding-left: 12px; font: size 1rem; color: #fff;">
            Equity Crowdfunding adalah istilah untuk layanan urun dana melalui penawaran saham berbasis teknologi informasi.

            Sederhananya..

            Santara adalah penghubung antara pelaku bisnis yang ingin mengembangkan usahanya dengan masyarakat yang ingin memiliki bisnis (investor).
            Menarik, bukan?
        </p>

        <p style="font-weight: bold; font-family:Nunito; color: #fff;">Bagi Anda pelaku bisnis</p>
        <p style="padding-left: 12px; color: #fff;">
            Di Santara Anda bisa mendapatkan pendanaan untuk mengembangkan bisnis Anda dengan cara menawarkan sebagian saham bisnis Anda kepada investor.

            Tanpa bunga, tanpa denda, cukup bagi dividen hasil usaha saja.
        </p>


        <p style="font-weight: bold; font-family:Nunito; color: #fff;">
            Bagi Anda yang ingin memiliki bisnis
        </p>

        <p style="padding-left: 12px; color: #fff;">
            Santara membantu Anda untuk menseleksi bisnis unggulan, Anda dapat berinvestasi membeli saham pada sebuah bisnis dan menikmati passive income dari dividen dari hasil usaha tersebut.
        </p>

        <p style="padding-left: 12px; color: #fff;">

            Bisnis sudah berjalan dan menguntungkan dan Anda tidak perlu ‘ribet’ ikut mengurus operasional bisnisnya.

        </p>

        <p style="padding-left: 12px; color: #fff;">

            Kerjasama antara pelaku bisnis dan investor ini dilakukah dengan sistem bagi dividen hasil usaha.

        </p>


        <p style="padding-left: 12px; color: #fff;">
            Dengan pola ini, kami berharap semakin banyak bisnis UKM yang mampu Naik Kelas. Saat bisnis semakin berkembang, manfaatnya dirasakan oleh lebih banyak orang.
...
<div class="contaner-fluid">
        <iframe class="youtube" src="https://www.youtube.com/embed/DSO7qWAbqjg" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</div>

  <div class="container-fluid bg-disclaimer">
      <div class="row" style="background-color: '#708088';">
          <div class=" col-md-6 d-flex justify-content-center " style="font-family: Mulish;margin-bottom: -30px;">
              <img src="https://old.santara.co.id/assets/new-santara/img/android-ios/aplikasi.svg" alt="aplikasi" class="img-fluid img-android" />
          </div>
          <div class="col-md-6 d-flex align-content-center flex-wrap text-left download">
              <div class="col-12 mt-4">
                  <img src="https://old.santara.co.id/assets/new-santara/img/logo/logo_header.png" alt="logo header" style="max-height: 57px;" />
              </div>
              <div class="col-12 mt-3">
                  <p class="fs-27 ff-m" style="color: #fff;">Equity Crowdfunding Indonesia</p>
              </div>
              <div class="col-12 mt-5">
                  <p class="fs-16 ff-m" style="color: #fff;">Download sekarang di</p>
              </div>
              <div class="row col-12 d-flex align-content-center">
