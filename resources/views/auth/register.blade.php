    ...
    <div class="row d-flex align-content-center justify-content-center flex-wrap row-login">
        <div class="col-md-10">
            <div class="row card-body-login">
                <div
                    class="row card col-md-5 d-flex align-content-center justify-content-center flex-wrap text-center p-4 img-login">
                    <div class="row d-flex align-content-center justify-content-center flex-wrap text-center">
                        <img src="{{ asset('public/new-santara/img/logo/santara-black.svg') }}" alt="logo santara"
                ...
                <div
                    class="row col-md-7 d-flex align-content-center justify-content-center flex-wrap  bg-login row-form-login p-3">
                            ...
                            <form class="form-login" id="form_login" method="POST" action="{{ route('register') }}">
                                ...
                                <div class="form-group mb-3" style="color: black; margin-left: -15px;">
                                    <div class="input-group col-12 ff-m" style="padding-right: 0;">
                                        <input type="number"
                                            class="form-control d-block required-form number-only-phone"
                                            style=" width: 100% !important" value="" name="phone" id="phone"
                                            placeholder="821xxxxxx" maxlength="14" onkeypress="return numberOnly(event)"
                                            value="">
                                ...
                                <div class="form-group mb-3">
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-text" style="background-color: #fff;"><i id="eye"
                                                class="fas fa-eye-slash" onclick="showHidePwd();"></i></span>
                                    </div>
                                </div>
                                <div class="form-group mb-3">
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-text" style="background-color: #fff;"><i id="eye2"
                                                class="fas fa-eye-slash" onclick="showHidePwd();"></i></span>
                                    </div>
                                </div>
                                <div class="form-group mb-3">
                                ...
                                <div class="row fs-11 ff-m mt-2">
                                    ...
                                    <div class="row col-lg-6 d-flex align-content-end text-end">
                                        <p style="font-size: 12px;">Sudah punya akun? <a class="link"
                                                href="{{ route('login') }}">&ensp; Login</a></p>
                                    </div>
                                </div>
...
<link rel="stylesheet" type="text/css"
    href="https://old.santara.co.id/app-assets/new-santara/vendors/intlTelInput/css/intlTelInput.min.css">
