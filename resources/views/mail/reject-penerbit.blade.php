                                        ...
                                        <div
                                            ...
                                            <div align='left' class='img-container left fixedwidth'
                                                ...
                                                <!--[if mso]><table width='100%' cellpadding='0' cellspacing='0' border='0'><tr style='line-height:0px'><td style='padding-right: 0px;padding-left: 0px;' align='left'><![endif]--><img
                                                    ...
                                                    src='http://emailasset.santara.co.id/Logo.png'
                                                ...
                                                <!--[if mso]><table width='100%' cellpadding='0' cellspacing='0' border='0' style='border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;'><tr><td style='padding-top: 10px; padding-right: 0px; padding-bottom: 10px; padding-left: 10px' align='right'><v:roundrect xmlns:v='urn:schemas-microsoft-com:vml' xmlns:w='urn:schemas-microsoft-com:office:word' href='https://santara.co.id' style='height:28.5pt; width:105.75pt; v-text-anchor:middle;' arcsize='37%' stroke='false' fillcolor='#e3edfe'><w:anchorlock/><v:textbox inset='0,0,0,0'><center style='color:#052d3d; font-family:Tahoma, Verdana, sans-serif; font-size:14px'><![endif]--><a
                                                    ...
                                                    mso-border-alt: none; word-break: keep-all;' target='_blank'><span
                                                        ...
                                                        <span style='font-size: 16px; line-height: 32px;'><span
                                                                style='font-size: 14px; line-height: 28px;'>Website</span></span>
                                                    </span></a>
                                        ...
                                        <div
                                            ...
                                            <div align='center' class='img-container center fixedwidth'
                                                ...
                                                <div style='font-size:1px;line-height:45px'> </div><img align='center'
                                                    ...
                                                    src='http://emailasset.santara.co.id/illo_welcome_1.png'
                                            ...
                                            <div style='color:#052d3d;font-family:' Lato', Tahoma, Verdana, Segoe,
                                                sans-serif;line-height:150%;padding-top:20px;padding-right:10px;padding-bottom:0px;padding-left:15px;'>
                                                <div style='line-height: 18px; font-family: ' Lato', Tahoma, Verdana,
                                                    Segoe, sans-serif; font-size: 12px; color: #052d3d;'>
                                                    <p
                                                        style='line-height: 57px; text-align: center; font-size: 12px; margin: 0;'>
                                                        <span style='font-size: 24px;'><strong>Hello,</strong></span>
                                                    </p>
                                                    <p
                                                        ...
                                                        <span style='font-size: 34px;'><strong><span
                                                                    style='line-height: 51px; font-size: 34px;'><span
                                                                        style='color: #2190e3; line-height: 51px; font-size: 20px;'>{{ $details['name'] }}"</span></span></strong></span>
                                                    </p>
                                                </div>
                                            </div>
                                            <!--[if mso]></td></tr></table><![endif]-->
                                            ...
                                            <div style='color:#555555;font-family:' Lato', Tahoma, Verdana, Segoe,
                                                sans-serif;line-height:120%;padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;'>
                                                <div style='font-size: 12px; line-height: 14px; font-family: ' Lato',
                                                    Tahoma, Verdana, Segoe, sans-serif; color: #555555;'>

                                                    <p
                                                        style='font-size: 14px; line-height: 21px; text-align: left; margin: 0;'>
                                                        <span style='font-size: 16px; color: #000000;'>Terimakasih sudah
                                                            melakukan pendaftaran bisnis <b>{{ $details['trademark'] }}</b>
                                                            melalui fitur Pra Listing Santara.
                                                        </span>
                                                    </p>
                                                    <br />
                                                    <p
                                                        style='font-size: 14px; line-height: 21px; text-align: left; margin: 0;'>
                                                        <span style='font-size: 16px; color: #000000;'>Kami telah
                                                            melakukan screening terhadap pengajuan bisnis Anda dan
                                                            menemukan bahwa terdapat beberapa kriteria yang belum
                                                            terpenuhi.
                                                            Perlu kami sampaikan sebelumnya bahwa kriteria untuk bisa
                                                            lolos ke tahap Pra Listing Santara yaitu PAS (Profitable,
                                                            Accountable, Sustainable).
                                                            Oleh karena itu, kami beritahukan bahwa untuk saat ini
                                                            bisnis Anda belum bisa lolos ke fitur Pra Listing Santara
                                                            dikarenakan alasan di bawah ini :
                                                            <br /><br /><b>{{ $details['reason'] }}</b></span>
                                                    </p>
                                                    <br />
                                                    <p
                                                        style='font-size: 14px; line-height: 21px; text-align: left; margin: 0;'>
                                                        <span style='font-size: 16px; color: #000000;'>Pada masa
                                                            mendatang tidak menutup kemungkinan untuk bisnis Anda bisa
                                                            masuk ke jajaran Pra Listing Santara apabila memang sudah
                                                            memenuhi kriteria PAS tersebut.</span>
                                                    </p>
                                                    <br />
                                                    <p
                                                        style='font-size: 14px; line-height: 21px; text-align: left; margin: 0;'>
                                                        <span style='font-size: 16px; color: #000000;'>Semoga sukses
                                                            selalu untuk bisnis Anda.</span>
                                                    </p>
                                                    <br />
                                                    <p
                                                        style='font-size: 14px; line-height: 21px; text-align: left; margin: 0;'>
                                                        <span style='font-size: 16px; color: #000000;'>Terimakasih,
                                                    </p>
                                                </div>
                                            </div>
                                            <div align='center' class='button-container'
                                                ...
                                                <a href="{{ url( 'login' ) }}"
                                                    ...
                                                    Lato', Tahoma, Verdana, Segoe, sans-serif; text-align: center;
                                                    mso-border-alt: none; word-break: keep-all;' target='_blank'><span
                                                        style='padding-left:40px;padding-right:40px;font-size:16px;display:inline-block;'>
                                                        <span
                                                            style='font-size: 16px; line-height: 32px;'><strong>Login</strong></span>
                                                    </span></a>
                                            </div>
                                        </div>
                                        <!--<![endif]-->
                                ...
                                <div class='col num12'
                                    ...
                                    <div style='width:100% !important;'>
                                        ...
                                        <div
                                                            ...
                                                            <table activate='activate' align='center'
                                                                ...
                                                                <tbody>
                                                                    <tr align='center'
                                                                        ...
                                                                        <td style='word-break: break-word; vertical-align: top; padding-bottom: 5px; padding-right: 8px; padding-left: 8px;'
                                                                            valign='top'><a
                                                                                href='https://instagram.com/santaracoid'
                                            ...
                                            <!--[if mso]><table width='100%' cellpadding='0' cellspacing='0' border='0'><tr><td style='padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px; font-family: Tahoma, Verdana, sans-serif'><![endif]-->
                                            <div style='color:#555555;font-family:' Lato', Tahoma, Verdana, Segoe,
                                                sans-serif;line-height:150%;padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;'>
                                                <div style='font-size: 12px; line-height: 18px; font-family: ' Lato',
                                                    Tahoma, Verdana, Segoe, sans-serif; color: #555555;'>
                                                    <p
                                                        style='font-size: 14px; line-height: 21px; text-align: center; margin: 0;'>
                                                        PT Santara Daya Inspiratama </p>
                                                    <p
                                                        style='font-size: 14px; line-height: 21px; text-align: center; margin: 0;'>
                                                        Jl. Pasir No 35, Patukan, Gamping, Sleman Yogyakarta 55293</p>
                                                </div>
                                            </div>
                                            <!--[if mso]></td></tr></table><![endif]-->
                                            <table border='0' cellpadding='0' cellspacing='0' class='divider'
                                            ...
                                            <!--[if mso]><table width='100%' cellpadding='0' cellspacing='0' border='0'><tr><td style='padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px; font-family: Tahoma, Verdana, sans-serif'><![endif]-->
                                            <div style='color:#4F4F4F;font-family:' Lato', Tahoma, Verdana, Segoe,
                                                sans-serif;line-height:120%;padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;'>
                                                <div style='font-size: 12px; line-height: 14px; font-family: ' Lato',
                                                    Tahoma, Verdana, Segoe, sans-serif; color: #4F4F4F;'>
                                                    <p
                                                        style='font-size: 12px; line-height: 16px; text-align: center; margin: 0;'>
                                                        <span style='font-size: 14px;'><a href='https://santara.co.id'
                                                                rel='noopener'
                                                                style='text-decoration: none; color: #2190E3;'
                                                                target='_blank'><strong>Official
                                                                    Website</strong></a>
                                                            | (0274) 2822744 </span>
                                                    </p>
                                                </div>
