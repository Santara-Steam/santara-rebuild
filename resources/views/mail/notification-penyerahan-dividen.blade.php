                                                ...
                                                <div
                                                    ...
                                                    <p
                                                        ...
                                                        <strong><span
                                                                ...
                                                                Penyerahan Dividen</span></strong>
                                                    </p>
                                                </div>
                                            </div>
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <p
                                                        ...
                                                        <span style="color: #808389; font-size: 15px;">Kami mengingatkan
                                                            kepada {{ $details['company_name'] }} untuk melakukan
                                                            pembagian
                                                            dividen pada tanggal
                                                            <strong>{{ tgl_indo(date('Y-m-d', strtotime($details['tanggal_dividen']))) }}</strong>.<br>
                                                            Sekian Terimakasih.
                                                        </span>
                                                    </p>
                                                </div>
