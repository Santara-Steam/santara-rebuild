                                    ...
                                    <div class="col-md-6">
                                        ...
                                        font-weight: 400;color: #464855;">
                                            ...
                                            <tr>
                                                ...
                                                <td style="padding-top:10px ">:</td>
                                                <td class="px-1" style="padding-top:10px ">{{ $book->emtn->trademark}}
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding-top:10px ">Kode Emiten</td>
                                                <td style="padding-top:10px ">:</td>
                                                <td class="px-1" style="padding-top:10px ">{{ $book->emtn->code_emiten}}
                                                </td>
                                            </tr>
                                            <tr>
                                    ...
                                    <div class="col-md-6">
                                        <table class="table">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="badge badge-success">Bukti Transfer Terkonfirmasi</div>
                                                </td>
