      ...
      <section id="basic-examples">
        <div class="row">
          <div class="col-12 mb-1">
            ...
            <p>Platform Equity Crowdfunding pertama yang berizin dan diawasi Otoritas Jasa Keuangan berdasarkan Surat
              Keputusan Nomor: KEP-59/D.04/2019.</p>
            {{-- {{Session::get('pwd')}} --}}
            {{-- {{Session::get('test')}} --}}
            {{-- {{Session::get('token')}} --}}
              ...
              <div class="card">
                ...
                <div class="card-content">
                  <div class="row" style="margin-top: 10px">
                    ...
                    <div class="col-6"><a style="float: right;    text-decoration: underline;"
                        href="{{url('user/portfolio')}}">Lihat Semua</a></div>
                  </div>
                          ...
                          <table style="width: 100%;">
                            <tbody>
                              <tr>
                                ...
                                <td class="value-intable-saham">{{tgl_indo(date('Y-m-d',
                                  strtotime($item['trx_date'])))}}</td>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                ...
                                <td class="value-intable-saham">
                                  <b>Rp&nbsp;{{number_format($item['total_saham'],0,',','.')}}</b></td>
                              </tr>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            @endif
                            <button class="btn btn-santara-white" style="cursor: default;">
                              <span style="color: #BF2D30; font-size:12px"><b>Batas
                                  : {{tgl_indo(date('Y-m-d',
                          ...
                          <td>
                            <div class="row">
                              ...
                              <a href="{{$item->redirect_url}}" target="_blank" class="btn btn-success col-6 col-md-12"
                                style="width:100px" title="Bayar">Bayar</a>
                              <a href="javascript:cancel();" class="btn btn-santara-red  cancelbtn col-6 col-md-12"
                                data-id="{{$item->id}}" style="width:100px" title="Bayar">Batal</a>
                            </div>
                          </td>
