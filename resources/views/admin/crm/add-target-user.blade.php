                                ...
                                <div class="card-body">
                                    <form id="formTargetUser" enctype="multipart/form-data">
                                        ...
                                        <input type="hidden" name="id" id="id"
                                            @isset($target) value="{{ $target['id'] ? $target['id'] : '' }}" @endisset />
                                        <div class="row justify-content-center">
                                            <div class="col-4">
                                                <div class="form-group">
                                                    <input type="text" class="form-control" name="target_name"
                                                        id="target_name" maxlength="40"
                                                        @isset($target) value="{{ $target['name'] ? $target['name'] : '' }}" @endisset
                                                        ...
                                                        <div class="card border border-light rounded">
                                                            <div class="card-body">
                                                                ...
                                                                <div class="<?= isset($target['list'][3]) ? '' : 'hidden' ?>"
                                                                    ...
                                                                    <p><b
                                                                            id="el_3"><?= isset($target['list'][3]) ? $target['list'][3] : '' ?></b>
                                                                        Tahun</p>
                                                                    <a href="#" class="card-link"
                                                        ...
                                                        <div class="card border border-light rounded">
                                                            <div class="card-body">
                                                                ...
                                                                <div class="<?= isset($target['list'][4]) ? '' : 'hidden' ?>"
                                                                    ...
                                                                    <p><b
                                                                            id="el_4"><?= isset($target['list'][4]) ? $target['list'][4] : '' ?></b>
                                                                    </p>
                                                                    <a href="#" class="card-link"
                                                        ...
                                                        <div class="card border border-light rounded">
                                                            <div class="card-body">
                                                                ...
                                                                <div class="<?= isset($target['list'][5]) ? '' : 'hidden' ?>"
                                                                    ...
                                                                    <p><b
                                                                            id="el_5"><?= isset($target['list'][5]) ? $target['list'][5] : '' ?></b>
                                                                    </p>
                                                                    <a href="#" class="card-link"
                                                        ...
                                                        <div class="card border border-light rounded">
                                                            <div class="card-body">
                                                                ...
                                                                <div class="<?= isset($target['list'][6]) ? '' : 'hidden' ?>"
                                                                    ...
                                                                    <p><b
                                                                            id="el_6"><?= isset($target['list'][6]) ? $target['list'][6] : '' ?></b>
                                                                    </p>
                                                                    <a href="#" class="card-link"
                                                        ...
                                                        <div class="card border border-light rounded">
                                                            <div class="card-body">
                                                                ...
                                                                <div class="<?= isset($target['list'][8]) ? '' : 'hidden' ?>"
                                                                    ...
                                                                    <p><b
                                                                            id="el_8"><?= isset($target['list'][8]) ? $target['list'][8] : '' ?></b>
                                                                    </p>
                                                                    <a href="#" class="card-link"
                                                        ...
                                                        <div class="card border border-light rounded">
                                                            <div class="card-body">
                                                                ...
                                                                <div class="<?= isset($target['list'][9]) ? '' : 'hidden' ?>"
                                                                    ...
                                                                    <p><b
                                                                            id="el_9"><?= isset($target['list'][9]) ? $target['list'][9] : '' ?></b>
                                                                    </p>
                                                                    <a href="#" class="card-link"
                                                        ...
                                                        <div class="card border border-light rounded">
                                                            <div class="card-body">
                                                                ...
                                                                <div class="<?= isset($target['list'][11]) ? '' : 'hidden' ?>"
                                                                    ...
                                                                    <p><b
                                                                            id="el_11"><?= isset($target['list'][11]) ? $target['list'][11] : '' ?></b>
                                                                    </p>
                                                                    <a href="#" class="card-link"
                                                        ...
                                                        <div class="card border border-light rounded">
                                                            <div class="card-body">
                                                                ...
                                                                <div class="hidden my-1" id="input_12">
                                                                    <div class="pr-1"><input type="text"
                                                                            id="input_12_start" class="form-control"
                                                                            value="<?= isset($target['list'][12]) ? explode('-', $target['list'][12])[0] : '' ?>">
                                                                    </div>
                                                                    <div class="pr-1"><input type="text"
                                                                            id="input_12_end" class="form-control"
                                                                ...
                                                                <div class="<?= isset($target['list'][12]) ? '' : 'hidden' ?>"
                                                                    ...
                                                                    <p><b
                                                                            id="el_12"><?= isset($target['list'][12]) ? $target['list'][12] : '' ?></b>
                                                                    </p>
                                                                    <a href="#" class="card-link"
                                                        ...
                                                        <div class="card border border-light rounded">
                                                            <div class="card-body">
                                                                ...
                                                                <div class="<?= isset($target['list'][15]) ? '' : 'hidden' ?>"
                                                                    ...
                                                                    <p><b
                                                                            id="el_15"><?= isset($target['list'][15]) ? $target['list'][15] : '' ?></b>
                                                                    </p>
                                                                    <a href="#" class="card-link"
