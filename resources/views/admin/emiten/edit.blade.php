                                                ...
                                                <div class="col-3 text-center">
                                                    ...
                                                    <div class="image_area text-center">
                                                        <label for="upload_image4">
                                                            <img src="{{asset('public/upload')}}/{{$picture[2]}}" id="uploaded_image4"
                                                                class="img-responsive" />
                                                            <div class="overlay">
                                                        ...
                                                        <input type="file" name="image4" class="image" id="upload_image4"
                                                            style="display: none" />
                                                        <input type="text" hidden value="{{$picture[2]}}" name="owner" class="image"
                                                            id="owner" />
                                                    </div>
                                                ...
                                                <div class="col-4">
                                                    ...
                                                    <div class="image_area text-center">
                                                        <label for="upload_image3">
                                                            <img src="{{asset('public/upload')}}/{{$picture[3]}}" id="uploaded_image3"
                                                                class="img-responsive" />
                                                            <div class="overlay">
                                                        ...
                                                        <input type="file" name="image3" class="image" id="upload_image3"
                                                            style="display: none" />
                                                        <input type="text" value="{{$picture[3]}}" hidden name="galeri" class="image"
                                                            id="galeri" />
                                                    </div>
                                                ...
                                                <div class="col-4">
                                                    ...
                                                    <div class="image_area text-center">
                                                        <label for="upload_image5">
                                                            <img src="{{asset('public/upload')}}/{{$picture[4]}}" id="uploaded_image5"
                                                                class="img-responsive" />
                                                            <div class="overlay">
                                                        ...
                                                        <input type="file" name="image5" class="image" id="upload_image5"
                                                            style="display: none" />
                                                        <input type="text" value="{{$picture[4]}}" hidden name="galeri2" class="image"
                                                            id="galeri2" />
                                                    </div>
                                                </div>
                                                <div class="col-4">
                                                    ...
                                                    <div class="image_area text-center">
                                                        <label for="upload_image6">
                                                            <img src="{{asset('public/upload')}}/{{$picture[5]}}" id="uploaded_image6"
                                                                class="img-responsive" />
                                                            <div class="overlay">
                                                        ...
                                                        <input type="file" name="image6" class="image" id="upload_image6"
                                                            style="display: none" />
                                                        <input type="text" value="{{$picture[5]}}" hidden name="galeri3" class="image"
                                                            id="galeri3" />
                                                    </div>
                                                </div>
                                            </div>
