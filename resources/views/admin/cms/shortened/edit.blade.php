                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h1 class="card-title-member">Edit Shortened</h1>
                                </div>
                                        ...
                                        <form action="{{ url('admin/cms/shortened/update/'.$shortened->id) }}" method="POST">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" value="{{ $shortened->url }}" class="form-control alpha-numeric" name="url" placeholder="BeritaSantara" required/>
                                                </div>
                                            </div>
                                            <div class="form-group">
