                            ...
                            <div class="card-content collapse show">
                                <div class="card-body card-dashboard">
                                    <form enctype="multipart/form-data"
                                        action="{{ url('admin/cms/popup/update/'.$popup->uuid) }}" method="POST">
                                        @csrf
                                        <div class="form-group">
                                            <label><strong>Judul Popup</strong></label>
                                            <input class="form-control" name="title" value="{{ $popup->title }}"
                                                required />
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="custom-control custom-radio">
                                                <input type="radio" name="type" id="customRadio1"
                                                    class="custom-control-input" value="ONETIME" @if($popup->type ==
                                                'ONETIME') checked @endif />
                                            ...
                                            <div class="custom-control custom-radio">
                                                <input type="radio" name="type" id="customRadio2"
                                                    class="custom-control-input" value="FREQUENTLY" @if($popup->type ==
                                                'FREQUENTLY') checked @endif />
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <div class="form-group">
                                                        <label><strong>Tanggal akhir Popup ditampilkan {{
                                                                removeTgl000($popup->finish_date) }}</strong></label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="custom-control custom-radio">
                                                <input type="radio" name="action_button" id="customRadio3"
                                                    class="custom-control-input" value="0" @if($popup->action_text ==
                                                "") checked @endif>
                                            ...
                                            <div class="custom-control custom-radio">
                                                <input type="radio" name="action_button" id="customRadio4" value="1"
                                                    class="custom-control-input" @if($popup->action_text != "") checked
                                                @endif>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group pt-2">
                                                        <p style="font-size: 12px;"><i class="la la-info-circle"></i>
                                                            Pastikan file dalam bentuk JPG/JPEG</p>
                                                        <p style="font-size: 12px;"><i class="la la-info-circle"></i>
                                                            Resolusi yang disarankan 1280 X 720 ( atau berlaku
                                                            kelipatanya )</p>
                                                        <p style="font-size: 12px;"><i class="la la-info-circle"></i>
                                                            Ukuran file maksimal 5 MB</p>
                                                    </div>
                                                    <div class="preview">
                                                        <img id="file-ip-1-preview"
                                                            src="{{ config('global.BASE_API_FILE').'/uploads/popup/'.$popup->website_pict }}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group pt-2">
                                                        <p style="font-size: 12px;"><i class="la la-info-circle"></i>
                                                            Pastikan file dalam bentuk JPG/JPEG</p>
                                                        <p style="font-size: 12px;"><i class="la la-info-circle"></i>
                                                            Resolusi yang disarankan 300 x 400 ( atau berlaku
                                                            kelipatanya )</p>
                                                        <p style="font-size: 12px;"><i class="la la-info-circle"></i>
                                                            Ukuran file maksimal 5 MB</p>
                                                    </div>
                                                    <div class="preview">
                                                        <img id="file-ip-2-preview"
                                                            src="{{ config('global.BASE_API_FILE').'/uploads/popup/'.$popup->mobile_pict }}" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" name="website_url"
                                                        ...
                                                        value="{{ $popup->website_url }}" required />
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="custom-control custom-radio">
                                                <input type="radio" name="is_active" value="1" id="customRadio5"
                                                    class="custom-control-input" @if($popup->is_active == 1) checked
                                                @endif>
                                            ...
                                            <div class="custom-control custom-radio">
                                                <input type="radio" name="is_active" value="0" id="customRadio6"
                                                    class="custom-control-input" @if($popup->is_active == 0) checked
                                                @endif />
