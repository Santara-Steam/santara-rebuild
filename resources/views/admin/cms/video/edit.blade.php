                            ...
                            <div class="card-content collapse show">
                                <div class="card-body card-dashboard">
                                    <form action="{{ url('admin/cms/video/store') }}" method="POST">
                                        @csrf
                                        <input class="form-control" type="hidden" value="{{ $santaraVideo->uuid }}"
                                            name="uuid" maxlength="255" required />
                                        <div class="form-group">
                                            <label><strong>Judul Video</strong></label>
                                            <input class="form-control" name="title" maxlength="255"
                                                value="{{ $santaraVideo->title }}" required />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="category" id="category" required class="form-control">
                                                ...
                                                <option value="<?= $category['uuid'] ?>" <?=$santaraVideo->category ==
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="link" maxlength="255"
                                                value="{{ $santaraVideo->link }}" required />
                                            <small><i>* Maksimal 255 karakter</i></small>
                                        </div>
                                        <div class="form-group">
