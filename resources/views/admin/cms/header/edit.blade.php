                            ...
                            <div class="card-content collapse show">
                                <div class="card-body card-dashboard">
                                    <form enctype="multipart/form-data"
                                        action="{{ url('admin/cms/header/update/'.$header->id) }}" method="POST">
                                        @csrf
                                        <div class="form-group">
                                            <label>Name</label>
                                            <input class="form-control" name="title" value="{{ $header->title }}"
                                                required />
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="preview">
                                                        <img id="file-ip-1-preview"
                                                            src="{{ config('global.STORAGE_GOOGLE').'header/'.$row->pictures }}" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="preview">
                                                        <img id="file-ip-2-preview"
                                                            src="{{ config('global.STORAGE_GOOGLE').'header/'.$row->mobile }}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
