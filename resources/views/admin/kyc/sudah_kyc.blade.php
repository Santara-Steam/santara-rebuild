                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h1 class="card-title-member">Sudah New KYC</h1>
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body card-dashboard">
                                    <div class="table-responsive">
                                        <table class="table" id="tableSudahKyc">
                                            <thead>
                                                <tr>
                                                    <th width="20">No</th>
                                                    <th>Nama</th>
...
<script>
    loadData("");
        ...
        function loadData(filter) {
            var tableSudahKyc = $("#tableSudahKyc").DataTable({
                ajax: '{{ url("/admin/kyc/get-sudah-kyc") }}',
                responsive: true,
                processing: true,
                serverSide: true,
                order: [
