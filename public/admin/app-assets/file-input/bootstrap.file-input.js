...
(function (factory) {
    ...
    $.fn.fileinputLocales.en = {
        ...
        msgSizeTooLarge: 'Ukuran file maksimal <b>{maxSize} KB</b>.',        
        msgFilesTooLess: 'You must select at least <b>{n}</b> {files} to upload.',
        // msgFilesTooMany: 'Number of files selected for upload <b>({n})</b> exceeds maximum allowed limit of <b>{m}</b>.',
        msgFilesTooMany: 'File yang di unggah tidak dapat lebih dari <b>{m}</b>',
        ...
        msgInvalidFileType: 'Mohon upload file dengan type "{types}".',
        // msgInvalidFileExtension: 'Invalid extension for file "{name}". Only "{extensions}" files are supported.',
        msgInvalidFileExtension: 'Mohon upload file berekstensi "{extensions}".',
        msgFileTypes: {
            'image': 'image',
            'html': 'HTML',
            'text': 'text',
