...
$(document).ready(function () {
    ...
    //     if ((name != 'nama_perusahaan') && (name != 'nama_owner') && (name != 'kategori') && (name != 'foto_owner') && (name != 'logo_perusahaan')) {
    ...
    //     this.value = Angka(this.value);
    // })



    $('#deleteBisnis').click(function () {
        uuid = $('input[name=uuid]').val();
        $.ajax({
            url: '/daftarbisnis/daftarBisnisDelete/' + uuid,
            type: "DELETE",
            dataType: "json",
            success: function (data) {
                if (data.code == 200) {
                    Swal.fire({
                        type: 'success',
                        title: 'Selamat',
                        text: 'data bisnis Anda berhasil dihapus',
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (datas.code == 200) {
                            ...
                            uploaded_image = reader.result;
                            $('#list_produk').append(`<div class="col-5 p-1"><img src="${uploaded_image}" width="150px" height="125px" class="rounded" /></div>`);
    ...
    $('#formData').validate({
        ...
        submitHandler: function (form, e) {
            ...
            if (logo_perusahaan != '' && logo_owner != '' && foto_produk_perusahaan.length >= 3 && cover_perusahaan != '') {
                ...
                $.ajax({
                    url: "/daftarbisnis/daftarBisnisUpdate",
                    type: "POST",
                    dataType: "json",
                ...
                if (foto_produk_perusahaan.length == 0) {
                    ...
                    if (foto_produk_perusahaan.length < 3) {
